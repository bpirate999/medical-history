...
class WritingsControllerTest < ActionController::TestCase
  ...
  test "should create writing" do
    assert_difference('Writing.count') do
      post :create, writing: { diagnosis: @writing.diagnosis, patient_id: @writing.patient_id, treatment: @writing.treatment }
    end
  ...
  test "should update writing" do
    patch :update, id: @writing, writing: { diagnosis: @writing.diagnosis, patient_id: @writing.patient_id, treatment: @writing.treatment }
    assert_redirected_to writing_path(assigns(:writing))
  end
